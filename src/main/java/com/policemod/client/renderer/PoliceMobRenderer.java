...
public class PoliceMobRenderer extends HumanoidMobRenderer<PoliceMob, HumanoidModel<PoliceMob>> {
    ...
    @Override
    protected void renderHands(com.mojang.blaze3d.vertex.PoseStack poseStack, net.minecraft.client.renderer.MultiBufferSource bufferSource, int packedLight, PoliceMob entity, net.minecraft.client.model.HumanoidModel<PoliceMob> model) {
